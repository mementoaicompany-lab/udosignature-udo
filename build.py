...
navs={'signature':[('','홈'),('#brands','우리의 브랜드'),('about/','브랜드 이야기')],'travel':[('','홈·지도'),('places/','가볼만한곳'),('course/','여행코스'),('ferry/','배시간·가는 법'),('planning/','여행 준비')],'dalkom':[('','홈'),('menu/','아이스크림'),('story/','달콤한 이야기'),('visit/','오시는 길')],'peanut':[('','우도씨앗'),('#story','브랜드 이야기'),('#news','오픈 소식')],'cafe':[('','HOME / 우도 키에키'),('#mood','SPACE / 공간'),('#coffee','COFFEE / 커피'),('#opening','COMING SOON / 오픈 안내')]}
